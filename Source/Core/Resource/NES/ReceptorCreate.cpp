...
Route::Route(Server::Server *_Server, restbed::Service &_Service) {
  ...
  RequiredParams_.push_back("RiseTimeConstant_ms");
  RequiredParams_.push_back("DecayTimeConstant_ms");
...
void Route::RouteCallback(const std::shared_ptr<restbed::Session> _Session) {
    ...
    UpstreamQuery["RiseTimeConstant_ms"] = Request->get_query_parameter("RiseTimeConstant_ms", 0.0f);
    UpstreamQuery["DecayTimeConstant_ms"] = Request->get_query_parameter("DecayTimeConstant_ms", 0.0f);
